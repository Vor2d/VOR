...
public class VRController : MonoBehaviour
{
    ...
    public void VelocityThread2()
    {
        ...
        if (threadGo)
        {
            ...
            if (angularVelocityRead != angularVelocityLast)
            {
                ...
                logger.Append(stopwatch2.Elapsed.TotalSeconds.ToString("F6"));
                fixedtime = stopwatch2.Elapsed.TotalSeconds.ToString("F6");
    ...
    {
        file.WriteLine("AngularVelocity_X\tAngularVelocity_Y\tAngularVelocity_Z\tdeltaTime\tTotalTime");
        file.WriteLine(logger.ToString());
        file.Close();
